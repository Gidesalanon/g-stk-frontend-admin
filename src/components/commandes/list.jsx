            ...
            <>
                <Modal isOpen={this.state.ConfirmModal!=null} size='md'>
                    ...
                    <ModalFooter>
                        ...
                        <Button color="danger" onClick={() => {this.removeCommande(this.state.ConfirmModal);this.setState({ ConfirmModal: null });}}>Supprimer</Button>
                    </ModalFooter>
                </Modal>
                <Table
                    filterable
...
const mapStateProps = (state) => {
    return {
        ...
        reload_data: state.commande.reload_data,
    }
}
...
const mapDispatchToProps = dispatch => {
    ...
    return {
        setCurrentCommande: (current) => {
            dispatch({ type: 'current-commande', current })
        },
...
export default connect(mapStateProps, mapDispatchToProps)(CommandeListComponent)
