...
import ContentModulePhotos from '../components/media/ContentModulePhotos';
...
class MediaPage extends Component {
  ...
  render() {
    return (
      <>
        <Row>
          <ContentHeader className="col-md-4">Les Albums</ContentHeader>
        ...
        <ContentModulePhotos successRemove={this.onMediaRemoved}/>
